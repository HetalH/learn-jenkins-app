pipeline {
    ...
    environment {
        NETLIFY_SITE_ID = '15e5da1c-0da2-4346-b583-4cf9169ae788'
    ...
    stages {
            ...
            steps {
                withCredentials([usernamePassword(credentialsId: 'my-aws', passwordVariable: 'AWS_SECRET_ACCESS_KEY', usernameVariable: 'AWS_ACCESS_KEY_ID')]) {
                    sh '''
                        ...
                        aws s3 cp index.html s3://learn-jenkins-hetal-202507251650/index.html
                    '''
                }
      ...
      /*  stage('Approval') {
        ...
        stage('Deploy prod') {
            ...
            environment {
                CI_ENVIRONMENT_URL = 'https://benevolent-moxie-608209.netlify.app'
            }
